...
import sys # like a #include command in C++

def DataTypes(dummy): # this is a function. DataTypes is the name, and dummy is the argument
    #Integers & Floats
    tempInt = 5
    tempFloat = 4.5 
    ...
    sampleSTR[5]
    len(sampleSTR)
    sampleSTR[3:7] # starting from 3rd index all the way to 6th index
